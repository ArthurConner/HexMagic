...
# %% ../../nbs/water/river.ipynb 4
from pathlib import Path
sys.path.insert(0, str(Path().resolve().parent.parent))

# %% ../../nbs/water/river.ipynb 5
