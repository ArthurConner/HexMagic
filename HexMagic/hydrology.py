...
# %% auto #0
__all__ = ['waterTer', 'Watershed', 'DrainageBasins']
...
from .river import River, RiverDemo, SoilSystem, SoilType
...
class Watershed:
    ...
    def is_ocean(self) -> bool:
        ...
        return self.tributary.ocean_outlet is not None
...
# %% ../nbs/08_hydrology.ipynb #ce2a23fc
@patch
def max_flow_hex(self:Watershed):
    """Return (terminal_hex_id, total_water_volume) for the watershed."""
    flows = self.calculate_flow()
    calculate_flow
    
    return (self.terminal_hex, flows[self.terminal_hex])
...
# %% ../nbs/08_hydrology.ipynb #8a8d1c79
