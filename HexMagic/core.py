...
# %% auto 0
__all__ = ['sampleHex', 'hexStyle', 'canvas', 'grid', 'arrowLayer', 'perimeter_style', 'region', 'paths', 'overlay', 'sampleGrid',
           'showEast', 'showRing', 'line_demo', 'range_demo', 'rotation_demo', 'demo_region_erosion']

# %% ../nbs/00_core_dup1.ipynb 7
from .primitives import Hex, MapCord 


# %% ../nbs/00_core_dup1.ipynb 8
sampleHex = Hex(radius=50,center=MapCord(100,100))

sampleHex.vertices(), "\n-- We round edges so we can compare --\n", sampleHex.edges()

# %% ../nbs/00_core_dup1.ipynb 9
from .styles import StyleCSS,  SVGBuilder

# %% ../nbs/00_core_dup1.ipynb 10
#some drawing setup 
...
# %% ../nbs/00_core_dup1.ipynb 21
showEast(6)

# %% ../nbs/00_core_dup1.ipynb 24
...
# %% ../nbs/00_core_dup1.ipynb 25
showRing(12,ring=2)

# %% ../nbs/00_core_dup1.ipynb 41
...
# %% ../nbs/00_core_dup1.ipynb 47
from .primitives import HexRegion

# %% ../nbs/00_core_dup1.ipynb 49
grid = sampleGrid(3, fill="lightgray")
