...
# %% auto 0
__all__ = ['EASING_PRESETS', 'daisy_hdrs', 'app', 'rt', 'preview', 'simpleSVG', 'StyleDemo', 'Generatable', 'SVGDef', 'StyleCSS',
           'LayerAnimation', 'SVGLayer', 'SVGBuilder', 'get_preview', 'SVGPatternLoader', 'main']
...
class SVGDef(Generatable):
    ...
    def generate(self):
        return tag(self.tag, self.content,  **self.attributes)

    def display(self):
        ret = f"+{self.tag} Header\n"
