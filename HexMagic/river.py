...
# %% ../nbs/06_river.ipynb 5
from .voronoi import PlateKind

# %% ../nbs/06_river.ipynb 7
class RiverDemo:
    def __init__(self):
        self.help = ""
