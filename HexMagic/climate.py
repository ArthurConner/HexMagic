...
# %% auto 0
__all__ = ['Climate', 'WeatherColor', 'TerrainFactory']

# %% ../nbs/07_climate.ipynb 3
import numpy as np
import sys
import os
import math
...
class TerrainFactory:
    ...
    def create_ocean_world(bounds: MapRect, 
        ...
        # Store climate preset for later use
