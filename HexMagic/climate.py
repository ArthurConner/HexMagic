...
# %% auto 0
__all__ = ['isf', 'Climate', 'WeatherColor', 'Geology', 'TerrainFactory']
...
isf = isfWorld.terrain
isf.hexGrid.builder.adjust("soil", isfWorld.soil.soilOverlay())
