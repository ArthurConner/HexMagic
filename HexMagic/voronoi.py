...
# %% auto #0
__all__ = ['voronoi_seeds', 'PlateKind', 'Plate', 'mark_oceanic_plates', 'mark_oceanic_by_sides',
           'calculate_distances_from_ocean', 'generate_plate_terrain']
...
factor=1.5, oceanic_sides=[],seed=None):
    ...
    if len(oceanic_sides) > 0:
        mark_oceanic_by_sides(plates, grid, factor=factor, oceanic_sides=oceanic_sides)
